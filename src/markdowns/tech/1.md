---
id: 1
title: 'Promise.allSettled() with async await syntax'
author: 'Lawrence Su'
date: "2026-01-05"
slug: "promise_allsettled()_with_async_await_syntax"
thumbnail: "./tech_images/1_thumbnail.png"
tag: "javascript"
---

# Promise.allSettled() with async await syntax
...
Then we can resolve the promises, I use <abbr title="MDN doc"><a href='https://developer.mozilla.org/en-US/docs/Glossary/IIFE' target='_blank' rel='noopener noreferer'>IIFE</a></abbr>, where <abbr title="MDN doc"><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/void' target='_blank' rel='noopener noreferer'>void</a></abbr> is an operator to make the function an expression:
```js
void async function() {
    ...
    console.log("resolved: ", resolvedPromises, "rejects: ", rejectedPromises)
    // Expected output:
